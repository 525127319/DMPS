const DeviceYearStatisticService = require("./DeviceYearStatisticService");
...
class DeviceYearStatistController {
  ...
  async yearlist(ctx) {
    ...
    //in    ($in: {dev_id: [dev_id1, 2,3....]}) week: 41
      ...
      let data = await DeviceYearStatisticService.findByCondition(condition);
...
module.exports = new DeviceYearStatistController();
