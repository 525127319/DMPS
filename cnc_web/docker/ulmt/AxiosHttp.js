...
let checkTocken = url => {
  if (url.indexOf("token/create.do") > 0) {
    return false;
  }
  if (!sessionStorage.getItem("tocken")) {
    //跳转
  ...
  init = () => {
    ...
    //axios.defaults.baseURL = "http://127.0.0.1:3000/api";
       ...
       axios.defaults.baseURL =
         "http://119.23.105.72/gateway/dms/api";
  };
  // 程序上传的 baseURL
  feilurl() {
    //return "http://127.0.0.1:3000/api/";

      return "http://119.23.105.72/gateway/dms/api/";
  }
  // 程序下载的 baseURL
  downloadfeilurl() {
    //return "http://127.0.0.1:3000/";

      return "http://119.23.105.72/gateway/dms/";
  }

  getApiGate(){
      return 'http://119.23.105.72/gateway/api/token/create.do';
  }


getAPPId(){
    return "imcloudep-demo-gv1Yi";
}

getAppSecret(){
    return "G2Sc0nobDUFmfiAo2HFnJLBwChMSnIfapalwfHPdMQikIfOKaPJSV5F0hdcSf7hJ";
}
