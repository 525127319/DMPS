  ...
  init = () => {
    ...
    //axios.defaults.baseURL = "http://127.0.0.1:3000/api";
      ...
      axios.defaults.baseURL =
        "https://traceapp.casetekcorp.com:9001/gateway/dms2/api";
  };
  // 程序上传的 baseURL
  feilurl() {
    //return "http://127.0.0.1:3000/api/";

      return "https://traceapp.casetekcorp.com:9001/gateway/dms2/api/";
  }
  // 程序下载的 baseURL
  downloadfeilurl() {
    //return "http://127.0.0.1:3000/";

      return "https://traceapp.casetekcorp.com:9001/gateway/dms2/";
  }
...
getAPPId(){
    return "ks-imcloudep-VabwM";
}

getAppSecret(){
    return "BLtd49Q4KN5TwoXdLca3Bk7mbBOoO1VXG7Pg7NfdQ19M1zXAIbKwTXnpBtFpAfuG";
}
