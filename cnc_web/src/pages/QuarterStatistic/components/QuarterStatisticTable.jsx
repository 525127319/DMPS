...
export default class DepartmentTable extends Component {
    ...
    toDetail = function (record) {
        ...
        // sessionStorage.setItem('quarter',true);
    ...
    render() {
        ...
        // if (departmentData && departmentData.children){
        //     //let children = departmentData.children;
        //     departmentData = DepartmentStatusUtil.matchByShiftId(departmentData, shift);
        // }
