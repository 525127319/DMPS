                ...
                if (times){//如果一个times里有2次换刀，只抓第一次的时间
                    ...
                    for (let index = 0; index < times.length; index++) {
                        ...
                        waitTmp.details.push({s: TimeUtil.format(element.stime, TimeUtil.format6), 
                            ...
                            status: item.status});//当focus在这点上，显视内容
                    }
                }
                array.push(tmp);
                    ...
                    <div className='y-table-max'>
                        ...
                        <div className='y-max-r'>
                            <ul>
                               <li>
                                   <span>CELL</span>
                                   <span className="y-fs"><CDetailHeader department={record.dID}/></span>
                               </li>
                                <li>
                                    <span>标准换刀CT时间(s)：</span>
                                    {/* <span>60+/-5</span> */}
                                    <span>{this.state.ENGChgTool.stdTime?this.state.ENGChgTool.stdTime:"300"} +{this.state.ENGChgTool.UpBias?this.state.ENGChgTool.UpBias:"15"}/{this.state.ENGChgTool.LowBias?this.state.ENGChgTool.LowBias:"-15"}</span>
                                </li>
                                <li>
                                    <span>换刀次数：</span>
                    ...
                    <div className='y-table-max'>
                        ...
                        <div className='y-max-r'>
                            <ul>
                                <li>
                                    <span>标准待机时间(s)：</span>
                                    <span>{this.state.ENGWait.idleTime?this.state.ENGWait.idleTime:"50"}  +{this.state.ENGWait.idleUpBias?this.state.ENGWait.idleUpBias:"5"}/{this.state.ENGWait.idleLowBias?this.state.ENGWait.idleLowBias:"-5"}</span>
                                </li>
                                <li>
                                    <span>平均待机时间(s)：</span>
